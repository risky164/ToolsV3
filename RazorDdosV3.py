...
print("   ╔═════════════════════════╦════════════════════════════╗")
print("   ║                                                      Razor Tools V3                                                                                                      ║")
print("   ║  Razor No Counter                                                         ║")
print("   ║  Methods : Razor ║ TCP ║ UDP ║ HTTP ║ DDOS ║ JETX ║ OVH ║ NTP     ║")
print("   ║  Tools Ddos Made By Razor       		                                                                     ║")
print("╔╩═══════════════════════╝  ╚════════════════════════════╩╗")
...
def GetMethodByName(method):
    ...
    elif method in ("Razor", "UDP", "TCP", "NTP", "JETX", "OVH"):
        dir = f"tools.L4.{method.lower()}"
    elif method in ("HTTP", "Razor", "TCP"):
